...
contract AccessControl {
    ...
    event RoleAssigned(address indexed wallet, Role role, address whoUpdatedThis, uint256 timestamp);
    event RoleRemoved(
        address indexed wallet, Role role, Permission permission, address whoUpdatedThis, uint256 timestamp
    );
    ...
    function assignRole(address _address, Role _role) external {
        ...
        require(
            msg.sender == OWNER || role[msg.sender] == Role.ADMIN || role[msg.sender] == Role.MANAGER,
